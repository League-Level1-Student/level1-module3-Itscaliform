...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		text.setText("Press the matching key when Simon says otherwise press a different key");
		Panel.add(text);
	frame.add(Panel);
